export function Footer() {
  return (
    <footer className="py-16 border-t border-white/5 text-center font-mono">
      <div className="flex justify-center gap-8 md:gap-12 mb-8 opacity-40 grayscale">
      ...
      <p className="text-[10px] text-muted-foreground/50 tracking-[0.4em] uppercase font-bold">
