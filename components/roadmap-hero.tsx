...
export function RoadmapHero() {
  return (
    <section className="pt-32 md:pt-48 pb-16 md:pb-20 px-6">
      <div className="max-w-5xl mx-auto text-center space-y-6 md:space-y-8">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-foreground tracking-tighter leading-[1.0] text-balance text-gradient">
          Engineering Human
          <br />
