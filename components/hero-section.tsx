    ...
    <main className="pt-48 pb-32 px-6">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-10">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-foreground tracking-tighter leading-[1.0] text-balance text-gradient">
            Infrastructure for
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-primary hover:bg-primary/90 text-primary-foreground px-10 py-5 rounded-sm font-bold font-mono uppercase tracking-widest transition-all shadow-lg shadow-primary/20">
              Initialize Sync
            </button>
            <Link
              href="/roadmap"
              className="border border-border hover:border-primary px-10 py-5 rounded-sm font-bold font-mono uppercase tracking-widest text-foreground transition-all text-center"
            >
              View Roadmap
            </Link>
          </div>
