...
export default function PortalPage() {
  ...
  return (
    <>
      {!isSynced && <InitializeSync onComplete={() => setIsSynced(true)} />}

      <main
        className={`min-h-screen bg-background bg-grid ${!isSynced ? "opacity-0" : "opacity-100"} transition-opacity duration-500`}
      >
        <Navbar />
